...
internal class OutputDelegate(val name: String?) : ReadWriteProperty<Any?, String> {
 ...
 */
public object outputs : ReadWriteProperty<Any?, String> by OutputDelegate(null) {
     ...
     * Delegates return `""` if the delegate hasn't been set, or the value set by that delegate if it has been used.
     */
    public operator fun invoke(name: String): ReadWriteProperty<Any?, String> = OutputDelegate(name)
